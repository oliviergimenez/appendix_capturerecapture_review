---
title: "Analyses of the capture-recapture literature: 2000-2025 period"
...
To carry out a bibliometric analysis of the capture-recapture literature over the 2003-2023, we used the `R` package [bibliometrix](https://www.bibliometrix.org/). We also carried out a text analysis using topic modelling, for which we recommend the book [Text Mining with R](https://www.tidytextmining.com/).
...
We ended up with `r nrow(M)` articles. Note that WoS only allows 1000 items to be exported at once, therefore we had to repeat the same operation 10 times. 
...
The SDGs are: ![sdgs](figs/sdgs.png)
